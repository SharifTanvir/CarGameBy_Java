...
public class GameLevel2 extends JFrame implements ActionListener,KeyListener {
    ...
    public GameLevel2(){
        ...
        road = new ImageIcon(getClass().getResource("myroad.jpg"));
